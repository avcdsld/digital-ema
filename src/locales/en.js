export default {
    ...
    LETS_MAKE_EMA: "Write your 2026 wishes and create a digital Ema!",
    BUTTON_GETTING_STARTED: "Create Ema",
    WRITE_WISHES_FOR_NEW_YEAR: "Write your wishes for 2026!",
    WRITE_WISHES_DESCRIPTION: "This wish will be inscribed on the blockchain and remain in digital space.",
    WISHES_EXAMPLES: "e.g. Health, Success, Love, Happiness, World Peace...",
    YOUR_WISH: "Your wish",
    YOUR_NAME: "Your name",
    ...
    MODAL_MESSAGE1: "To create an Ema, you need to use a wallet on the Flow blockchain.",
