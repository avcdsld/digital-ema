...
flow scripts execute ./scripts/get_template_ids.cdc 0x179b6b1cb6755e31
...
# Transfer NFT
flow transactions send ./transactions/transfer_nft.cdc 0xf3fcd2c1a78f5eee 1 --signer emulator-account2

# View NFT Metadata
flow scripts execute ./scripts/get_collection_length.cdc 0xf3fcd2c1a78f5eee
flow scripts execute ./scripts/get_nft_metadata.cdc 0xf3fcd2c1a78f5eee 1
flow scripts execute ./scripts/get_nft_metadata_svgs.cdc 0xf3fcd2c1a78f5eee
